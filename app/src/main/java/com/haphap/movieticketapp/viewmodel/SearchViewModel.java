...
public class SearchViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<List<Movie>> getListMutableLiveData(String title) {
        Api apiService = Client.getService();
        Call<MovieResult> call = apiService.getSearchMovie(title);
    ...
    public LiveData<List<Movie>> getSearchMovie(String title) {
        return getListMutableLiveData(title);
    }
}
